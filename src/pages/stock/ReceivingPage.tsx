    ...
    <div className="flex flex-col gap-6 relative">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-bold text-white leading-tight">
              Smart<span className="text-gray-400">Stock</span>
            </h1>
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          <section className="w-full">
            ...
            <div className="grid grid-cols-3 gap-6 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
              <div>
        ...
        {/* 오른쪽 사이드바: 현재고 현황 요약 */}
        <div className="w-72 bg-white border border-gray-200 p-6 no-print shadow-sm rounded-2xl sticky top-24 shrink-0">
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="space-y-3">
            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="flex justify-between items-end">
                ...
                <span className="text-[10px] text-emerald-600 font-bold bg-emerald-50 px-1.5 rounded mb-1">
                  정상
                </span>
              </div>
            </div>
      ...
      >
        ...
        <div className="p-6 flex-1 overflow-y-auto space-y-6">
          <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-3xl p-8 text-center relative group">
            <input
              type="file"
              id="ocrInput"
              className="hidden"
