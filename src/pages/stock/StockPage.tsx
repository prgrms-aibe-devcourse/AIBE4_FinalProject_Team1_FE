    ...
    <div className="flex flex-col space-y-6">
      ...
      <div className="bg-[#1a1a1a] h-16 flex items-center justify-between px-6 shadow-md rounded-xl">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg">
            <i className="ph-fill ph-list text-[#1a1a1a] text-2xl"></i>
          </div>
          <div>
        ...
        <div className="flex gap-4">
          <div className="flex bg-gray-800 rounded-lg p-1">
            ...
            <button className="px-4 py-1.5 text-xs font-bold text-gray-400 hover:text-white transition-colors">
              미확정
            </button>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 text-sm font-bold text-white bg-black border border-gray-700 hover:bg-gray-800 rounded-lg transition-all shadow-md cursor-pointer"
          >
            <i className="ph ph-plus-circle"></i> 새 입고 등록
          </button>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 gap-6">
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-gray-800">128</span>
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between gap-4">
          ...
          <button className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-gray-600 hover:bg-gray-100 rounded-xl transition-all">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-100">
              {stockItems.map((item) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">
                    {item.status === "pending" ? (
                      <button className="p-1.5 hover:bg-gray-200 rounded-md text-amber-600 transition-all">
                        <i className="ph ph-scan text-lg"></i>
                      </button>
                    ) : (
                      <button className="p-1.5 hover:bg-gray-200 rounded-md text-gray-400 hover:text-black transition-all">
                        <i className="ph ph-note-pencil text-lg"></i>
                      </button>
                    )}
                  </td>
                </tr>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            ...
            <div className="flex gap-1">
              ...
              <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-black text-white font-bold text-xs">
                1
              </button>
              <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 font-bold text-xs transition-all">
                2
              </button>
              <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 font-bold text-xs transition-all">
                3
